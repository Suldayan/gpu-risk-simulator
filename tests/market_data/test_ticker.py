...
from risk_simulator.market_data.ticker import TickerParams, fetch_price_history, compute_gbm_params, estimate_ticker_params
from risk_simulator.market_data.errors import (
...
@patch("risk_simulator.market_data.ticker.yf.Ticker")
